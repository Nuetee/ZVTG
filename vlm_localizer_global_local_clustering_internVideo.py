...
module_path = Path("/home2/dltjdwns8379/InternVideo/InternVideo1/Pretrain/Multi-Modalities-Pretraining")
...
model = InternVideo.load_model("/home2/dltjdwns8379/InternVideo/InternVideo1/Pretrain/Multi-Modalities-Pretraining/InternVideo-MM-L-14.ckpt").cuda()
...
def calc_scores(video_features, sentences, gt, duration, gamma, kmeans_k, prior=1, temporal_window_size=21):
    ...
    initial_mask = (scores > 0)  # 0.2 이하 값은 False, 나머지는 True
